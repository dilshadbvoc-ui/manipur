  ...
  sections: [
    {
      ...
      members: [
        { sl: '1', name: 'Prof P Kumar Singh', designation: 'Pro-Vice Chancellor — Vice Chairperson', contact: '9774011289', email: 'dr.pkumar@miu.edu.in' },
        { sl: '2', name: 'Prof Irom Tomba Singh', designation: 'Dean School of Mathematical Sciences — Member', contact: '9862275312', email: 'dr.iromtomba@miu.edu.in' },
        { sl: '3', name: 'Prof S James', designation: 'Dean School of Law, Defence and Strategic Studies — Member', contact: '7980506093', email: 'Dr.jamess@miu.edu.in' },
        { sl: '4', name: 'Prof Charles Yuhlung', designation: 'Dean School of Social Sciences — Member', contact: '9862552550', email: 'dr.charles@miu.edu.in' },
        { sl: '5', name: 'Prof S Raghumani Singh', designation: 'Dean School of Agri and Allied Sciences — Member', contact: '7308150914', email: 'dr.raghumani@miu.edu.in' },
        { sl: '6', name: 'Prof Ng Ajitkumar', designation: 'Dean School of Biological Sciences — Member', contact: '9485227590', email: 'dr.ajitng@miu.edu.in' },
        { sl: '7', name: 'Prof Th Basanta Singh', designation: 'Dean School of Physical Sciences and Engineering — Member', contact: '8787740321', email: 'dr.basanta@miu.edu.in' },
        { sl: '8', name: 'Prof N Ibohal Singh', designation: 'Dean School of Human and Health Sciences — Member', contact: '9436891381', email: 'dr.ibohal@miu.edu.in' },
        { sl: '9', name: 'Prof Md Kheiruddin Shah', designation: 'Dean School of Commerce and Management Sciences — Member', contact: '9774935464', email: 'profkheiruddin@miu.edu.in' },
        { sl: '10', name: 'Dr Rajesh Chinchewadi', designation: 'Dean School of Innovation and Skill — Member', contact: '8286773679', email: 'dr.rajeshchinchewadi@miu.edu.in' },
        { sl: '11', name: 'Prof R K Indira Devi', designation: 'Dean School of Humanities — Member', contact: '9856459154', email: 'dr.rkindira@miu.edu.in' },
        { sl: '12', name: 'Prof W Sushma Devi', designation: 'Dean Students Welfare — Member', contact: '9818705195', email: 'dr.sushma@miu.edu.in' },
        { sl: '13', name: 'Prof H Prativa', designation: 'Professor — Member', contact: '', email: '' },
        { sl: '14', name: 'Prof R K Sujata', designation: 'Professor — Member', contact: '9856910930', email: 'dr.sujata@miu.edu.in' },
        { sl: '15', name: 'Prof Mayengbam Bidyarani Devi', designation: 'Professor — Member', contact: '9774338607', email: 'dr.mayenbidyarani@miu.edu.in' },
        { sl: '16', name: 'Prof Irom Shirly', designation: 'Professor — Member', contact: '9854844515', email: 'dr.iromshirly@miu.edu.in' },
        { sl: '17', name: 'Prof Chandibai Potsangbam', designation: 'Professor — Member', contact: '9774800960', email: 'dr.chandibai@miu.edu.in' },
        { sl: '18', name: 'Dr M Bidyarani Devi', designation: 'Associate Professor — Member', contact: '9774770034', email: 'dr.bidyarani@miu.edu.in' },
        { sl: '19', name: 'Dr Grihalaxmi Devi', designation: 'Associate Professor — Member', contact: '9774526966', email: 'dr.grihalakshmi@miu.edu.in' },
        { sl: '20', name: 'Dr Kh Mukta Singh', designation: 'Associate Professor — Member', contact: '7085383690', email: 'dr.khadangbammukta@miu.edu.in' },
        { sl: '21', name: 'Dr A Bijayalaxmi', designation: 'Associate Professor — Member', contact: '9611187749', email: 'dr.bijayalakshmi@miu.edu.in' },
        { sl: '22', name: 'Dr L Nonie', designation: 'Associate Professor — Member', contact: '9774293528', email: 'nonie.lourembam@miu.edu.in' },
        { sl: '23', name: 'Dr Salam Anand', designation: 'Associate Professor — Member', contact: '7085602359', email: 'dr.anandsalam@miu.edu.in' },
        { sl: '24', name: 'Dr Yumlembam Bidyananda', designation: 'Associate Professor — Member', contact: '9612318891', email: 'dr.bidyananda@miu.edu.in' },
        { sl: '25', name: 'Dr Senjam Jinus Singh', designation: 'Associate Professor — Member', contact: '6009073539', email: 'singhsenjam@gmail.com' },
      ],
    },
    {
